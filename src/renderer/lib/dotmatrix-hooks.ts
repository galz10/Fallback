...
import type { DotMatrixPhase } from "@/renderer/lib/dotmatrix-core";
...
export function useSteppedCycle({ active, cycleMsBase, steps, speed = 1, idleStep = 0 }: UseSteppedCycleOptions): number {
