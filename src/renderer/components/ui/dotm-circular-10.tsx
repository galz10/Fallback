...
import { isWithinCircularMask } from "@/renderer/lib/dotmatrix-core";
import { useCyclePhase } from "@/renderer/lib/dotmatrix-hooks";
...
export function DotmCircular10({ speed = 1.75, animated = true, hoverAnimated = false, ...rest }: DotmCircular10Props) {
